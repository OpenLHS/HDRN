 ...
 * [HDRN.yml](HDRN.yml)
     * Determines how your purl.obolibrary.org/obo/HDRN/ redirects will be handled
     ...
     * Paste in the contents of [HDRN.yml](HDRN.yml)
 ...
 * [HDRN.md](HDRN.md)
     ...
     * Paste in the contents of [HDRN.md](HDRN.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
